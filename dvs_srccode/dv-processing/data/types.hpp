...
static_assert(alignof(TimeElementExtractor) == sizeof(int64_t), "TimeElementExtractor alignment is unexpected");
...
static_assert(
	(sizeof(size_t) == sizeof(int32_t)) ? (alignof(Type) == sizeof(int32_t)) : (alignof(Type) == sizeof(int64_t)),
...
static_assert((sizeof(size_t) == sizeof(int32_t)) ? (alignof(TypedObject) == sizeof(int32_t))
